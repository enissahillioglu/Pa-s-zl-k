<%@ Page Language="C#" AutoEventWireup="true" CodeFile="etkinlikler.aspx.cs" Inherits="etkinlikler" %>
...
<form id="form1" runat="server">
     <div id="wrapper">
           <header >
             ...
             <div class="logoiki"><a href="sözlük.aspx"><img src="images/logo2.png" width="100px" height="15px" /> </a>
               ...
               <div class="arama-wrap" >
                   ...
                   <asp:button ID="btnarama" cssClass="btnarama" text="ara" runat="server" OnClick="btnarama_Click2"  />
               </div>
        ...
        <div class="banneralan">
            ...
            <div class="banner"><img src="image/DB-Etkinlik.jpg"  width="100%" height="100%" /></div>
            <div class="banner"><img src="image/WBR-290416-etkinlik-1-800.jpg"  width="100%"height="100%" /></div>
             ...
             <div class="icerik">
                 <div class="ortalan">
                    ...
                    <div class="sagbolum">
                             <div class="populer"><img src="images/populer.jpg" width="100%" height="100%" />
                        </div>
